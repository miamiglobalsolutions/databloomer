      ...
      <section className="border-t border-stone-200 bg-stone-100">
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 text-center">
          ...
          <p className="text-sm text-stone-600">
            ...
            Serving roofing contractors across Miami-Dade County.{" "}

            <Link href="/about" className="font-medium text-orange-700 hover:underline">
              Learn more
            </Link>
            {" · "}
            <Link href="/subscribe" className="font-medium text-orange-700 hover:underline">
